...
if(f.started){var t={e:e,lastX:l,lastY:d,lineThickness:p,pencilColor:c,context:s,pencilThickness:u,isMakingOwnChanges:!0,transmissionService:i},a=o.call(this,t)
l=a.lastX,d=a.lastY}(function(e,t,o){r.clearRect(0,0,n.width,n.height),r.strokeStyle="#f00",r.lineWidth=1,r.beginPath()
var a=e/2
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+536fca15"})
