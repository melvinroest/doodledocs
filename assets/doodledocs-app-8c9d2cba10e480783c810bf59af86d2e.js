...
"ping"!==o.type&&"welcome"!==o.type&&"confirm_subscription"!==o.type&&e(o.message.args)}}},startService:function(e){if(this.transmissionSetting=e||o.P2P,this.transmissionSetting===o.P2P)this.transmissionInstance=((a=new t.default("debugswarm")).on("seen",function(e){var t=document.createElement("p")
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+a5d43da0"})
