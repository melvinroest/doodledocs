...
var i=o/2
e.rect(n-i,a-i,o,o),e.stroke()}function i(e){var t=e.e,o=e.lastX,n=e.lastY,a=e.pencilColor,i=e.context,s=e.pencilThickness,r=e.isMakingOwnChanges,l=e.transmissionService,d=t._x,u=t._y,c=d,p=o,f=u,m=n,h=void 0,v=void 0,b=Math.abs(m-f)>=Math.abs(p-c)
b&&(h=c,c=f,f=h,v=m,m=p,p=v),c>=p&&(h=c,c=p,p=h,v=f,f=m,m=v)
var g=p-c,y=0,x=Math.abs(m-f)/g,_=-1
if(v=f,f<=m&&(_=1),r){var w={e:{_x:t._x,_y:t._y,userForce:t.userForce},lastX:o,lastY:n,pencilColor:a,pencilThickness:s}
l.send(w)}for(var P=(s+=8*t.userForce)/2,M=c;M<p;M++)b?i.fillRect(v-P,M-P,s,s):i.fillRect(M-P,v-P,s,s),(y+=x)>=.5&&(v+=_,y-=1)
return{lastX:o=d,lastY:n=u}}Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(e,s,r){var l=this,d=s.getContext("2d")
s.style.width="100%",s.style.height="100%",s.width=s.offsetWidth,s.height=s.offsetHeight,d.clearRect(0,0,s.width,s.height),d.fillStyle="#FFFBEB",d.fillRect(0,0,s.width,s.height)
var u=e.getContext("2d")
e.style.width="100%",e.style.height="100%",e.width=s.offsetWidth,e.height=s.offsetHeight,u.clearRect(0,0,s.width,s.height)
var c=new o.default("rgba(0, 0, 0, 0.33)",1,d,s,u,r);["click","touchstart"].forEach(function(e){document.getElementById("pencil").addEventListener(e,function(e){c.pencilThickness=1,c.pencilColor="rgba(0, 0, 0, 0.33)"})}),["click","touchstart"].forEach(function(e){document.getElementById("eraser").addEventListener(e,function(e){c.pencilThickness=20,c.pencilColor="#FFFBEB"})}),r.onReceivingMessage(function(e,t){(function(e,t,o,n,s){e.context=t,e.isMakingOwnChanges=!1,e.b=void 0,e.context.fillStyle=e.pencilColor,e.transmissionService=s,i.call(this,e),a(n,o,e.pencilThickness,e.e._x,e.e._y)})(e,d,s,u,r)})
var p={start:function(e){e=n.call(l,e),c.startDraw(e)},startDeepPress:function(e){e=n.call(l,e),c.startDraw(e)},change:function(e,t){t.userForce=e,t=n.call(l,t),c.duringDraw(t)},end:function(){var e={}
e=n.call(l,e),c.endDraw(e)},endDeepPress:function(){var e={}
e=n.call(l,e),c.endDraw(e)},unsupported:function(){l.innerHTML="Your device / browser does not support this :("}}
...
o.map(function(){this.route("site",function(){this.route("home"),this.route("faq")}),this.route("app",function(){this.route("doc",{path:"/:random_url"}),this.route("public")})})
var n=o
...
var t=Ember.HTMLBars.template({id:"vlQOjBy6",block:'{"symbols":[],"statements":[[5,"doodledoc",[],[[],[]]]],"hasEval":false}',meta:{moduleName:"doodledocs-app/templates/app/doc.hbs"}})
...
e.default=t})
define("doodledocs-app/templates/public",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+c69f3200"})
