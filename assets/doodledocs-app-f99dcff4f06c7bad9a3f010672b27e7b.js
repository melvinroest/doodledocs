...
e.default=n}),define("doodledocs-app/components/draw-engine",["exports","pressure"],function(e,t){function o(e){var t=e.e,o=e.lastX,n=e.lastY,a=e.lineThickness,i=e.pencilColor,s=e.context,r=e.pencilThickness,l=e.isMakingOwnChanges,d=e.transmissionService,u=t._x,c=t._y,p=u,f=o,m=c,h=n,v=void 0,b=void 0,g=Math.abs(h-m)>=Math.abs(f-p)
g&&(v=p,p=m,m=v,b=h,h=f,f=b),p>=f&&(v=p,p=f,f=v,b=m,m=h,h=b)
var y=f-p,x=0,_=Math.abs(h-m)/y,P=-1
if(b=m,m<=h&&(P=1),l){var E={e:{_x:t._x,_y:t._y,userForce:t.userForce},lastX:o,lastY:n,lineThickness:a,pencilColor:i,pencilThickness:r}
requestAnimationFrame(function(){d.send(E)})}for(var M=(a+=8*t.userForce)/2,w=p;w<f;w++)g?s.fillRect(b-M,w-M,a,a):s.fillRect(w-M,b-M,a,a),(x+=_)>=.5&&(b+=P,x-=1)
...
var l=0,d=0,u=1,c="rgba(0, 0, 0, 0.33)",p=u,f=new function(){var e=this
function t(t){e.started=!0,s.fillStyle=c,l=t._x-t.target.offsetLeft,d=t._y-t.target.offsetTop,p=u}function a(e){r.clearRect(0,0,n.width,n.height),f.started&&(f.started=!1)}this.started=!1,this.start=function(e){t(e)},this.startDeepPress=function(e){t(e)},this.change=function(e){performance.now()
var t=e.touches[0].touchType
if("stylus"===t&&f.started){var a={e:e,lastX:l,lastY:d,lineThickness:p,pencilColor:c,context:s,pencilThickness:u,isMakingOwnChanges:!0,transmissionService:i},m=o.call(this,a)
l=m.lastX,d=m.lastY}(function(e,t,o){r.clearRect(0,0,n.width,n.height),r.strokeStyle="#f00",r.lineWidth=1,r.beginPath()
var a=e/2
...
o.push(e.splice(a,1)[0])}return console.log("config",t.default),{examples:o,randomURL:"debug"}}})
...
"ping"!==o.type&&"welcome"!==o.type&&"confirm_subscription"!==o.type&&e(o.message.args)}}},startService:function(e){if(this.transmissionSetting=e||o.P2P,this.transmissionSetting===o.P2P)this.transmissionInstance=((a=new t.default("debug")).on("seen",function(e){var t=document.createElement("p")
t.innerHTML="Bugout address ".concat(e," connected"),document.getElementById("content").append(t)}),a)
else if(this.transmissionSetting===o.SERVER){this.transmissionInstance=function(e){var t=new WebSocket(e)
return t.onopen=function(e){t.send(n({command:"subscribe",identifier:{channel:"MessageChannel",urlPath:"dd:".concat(window.location.pathname.split("dd:")[1])}}))},t}("ws://localhost:8888/websocket")}var a
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+d53da702"})
