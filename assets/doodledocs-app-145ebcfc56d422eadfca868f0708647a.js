...
return n}(8,"aA#!"))
return"gh-pages"===t.default.environment&&(i="debug"),{examples:o,randomURL:i}}})
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+64085a93"})
