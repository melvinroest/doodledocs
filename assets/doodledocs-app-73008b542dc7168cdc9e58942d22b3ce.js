...
var n=function(){function e(t,o,n,a,i,s){(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,e),this.started=!1,this.pencilColor=t,this.pencilThickness=o,this.context=n,this.canvas=a,this.hudContext=i,this.transmissionSerice=s}var n,a,i
return n=e,(a=[{key:"startDraw",value:function(e){this.started=!0,this.context.fillStyle=this.pencilColor,this.lastX=e._x-e.target.offsetLeft,this.lastY=e._y-e.target.offsetTop}},{key:"duringDraw",value:function(e){if(this.started){var o={e:e,lastX:this.lastX,lastY:this.lastY,pencilColor:this.pencilColor,context:this.context,pencilThickness:this.pencilThickness,isMakingOwnChanges:!0,transmissionService:this.transmissionSerice},n=t.bresenhamsLineAlgorithm.call(this,o)
this.lastX=n.lastX,this.lastY=n.lastY,(0,t.drawHud)(this.hudContext,this.canvas,this.pencilThickness,e._x,e._y)}}},{key:"endDraw",value:function(e){this.hudContext.clearRect(0,0,this.canvas.width,this.canvas.height),this.started&&(this.started=!1)}}])&&o(n.prototype,a),i&&o(n,i),e}()
...
a.startService(a.TRANSMISSIONMODE.P2P),o.default.call(this,e,n,a)}},willDestroyElement:function(){(0,t.enablePageScroll)(),this._super.apply(this,arguments)}})
...
var i=o/2
e.rect(n-i,a-i,o,o),e.stroke()}function i(e){var t=e.e,o=e.lastX,n=e.lastY,a=e.pencilColor,i=e.context,s=e.pencilThickness,r=e.isMakingOwnChanges,d=e.transmissionService,l=t._x,c=t._y,u=l,p=o,f=c,m=n,h=void 0,v=void 0,g=Math.abs(m-f)>=Math.abs(p-u)
g&&(h=u,u=f,f=h,v=m,m=p,p=v),u>=p&&(h=u,u=p,p=h,v=f,f=m,m=v)
var b=p-u,y=0,x=Math.abs(m-f)/b,_=-1
if(v=f,f<=m&&(_=1),r){var P={e:{_x:t._x,_y:t._y,userForce:t.userForce},lastX:o,lastY:n,pencilColor:a,pencilThickness:s}
d.send(P)}for(var w=(s+=8*t.userForce)/2,M=u;M<p;M++)g?i.fillRect(v-w,M-w,s,s):i.fillRect(M-w,v-w,s,s),(y+=x)>=.5&&(v+=_,y-=1)
return{lastX:o=l,lastY:n=c}}Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(e,s,r){var d=this,l=s.getContext("2d")
s.style.width="100%",s.style.height="100%",s.width=s.offsetWidth,s.height=s.offsetHeight,l.clearRect(0,0,s.width,s.height),l.fillStyle="#FFFBEB",l.fillRect(0,0,s.width,s.height)
var c=e.getContext("2d")
e.style.width="100%",e.style.height="100%",e.width=s.offsetWidth,e.height=s.offsetHeight,c.clearRect(0,0,s.width,s.height)
var u=new o.default("rgba(0, 0, 0, 0.33)",1,l,s,c,r);["click","touchstart"].forEach(function(e){document.getElementById("pencil").addEventListener(e,function(e){u.pencilThickness=1,u.pencilColor="rgba(0, 0, 0, 0.33)"})}),["click","touchstart"].forEach(function(e){document.getElementById("eraser").addEventListener(e,function(e){u.pencilThickness=20,u.pencilColor="#FFFBEB"})}),r.onReceivingMessage(function(e,t){(function(e,t,o,n,s){e.context=t,e.isMakingOwnChanges=!1,e.b=void 0,e.context.fillStyle=e.pencilColor,e.transmissionService=s,i.call(this,e),a(n,o,e.pencilThickness,e.e._x,e.e._y)})(e,l,s,c,r)})
var p={start:function(e){e=n.call(d,e),u.startDraw(e)},startDeepPress:function(e){e=n.call(d,e),u.startDraw(e)},change:function(e,t){t.userForce=e,t=n.call(d,t),u.duringDraw(t)},end:function(){var e={}
e=n.call(d,e),u.endDraw(e)},endDeepPress:function(){var e={}
e=n.call(d,e),u.endDraw(e)},unsupported:function(){d.innerHTML="Your device / browser does not support this :("}}
t.default.set(s,p)},e.drawHud=a,e.bresenhamsLineAlgorithm=i}),define("doodledocs-app/components/example-image",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
var t=Ember.Route.extend({})
e.default=t}),define("doodledocs-app/routes/site/home",["exports","doodledocs-app/config/environment"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
o.push(e.splice(a,1)[0])}var i="dd:".concat(function(e,t){var o=""
...
return n}(8,"aA#!"))
return"gh-pages"===t.default.buildTarget&&(i="gh-pages"),{examples:o,randomURL:i}}})
e.default=o}),define("doodledocs-app/services/ajax",["exports","ember-ajax/services/ajax"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.default}})}),define("doodledocs-app/services/transmission-service",["exports","bugout","doodledocs-app/config/environment"],function(e,t,o){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
"ping"!==o.type&&"welcome"!==o.type&&"confirm_subscription"!==o.type&&e(o.message.args)}}},startService:function(e){if(this.transmissionSetting=e||n.P2P,this.transmissionSetting===n.P2P)this.transmissionInstance=(i="dd:".concat(window.location.pathname.split("dd:")[1]),s=new t.default(i),"gh-pages"===o.default.buildTarget&&(i="gh-pages"),s.on("seen",function(e){var t=document.createElement("p")
t.innerHTML="Bugout address ".concat(e," connected"),document.getElementById("content").append(t)}),s)
else if(this.transmissionSetting===n.SERVER){this.transmissionInstance=function(e){var t=new WebSocket(e)
return t.onopen=function(e){t.send(a({command:"subscribe",identifier:{channel:"MessageChannel",urlPath:"dd:".concat(window.location.pathname.split("dd:")[1])}}))},t}("ws://localhost:8888/websocket")}var i,s
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+007d9883"})
