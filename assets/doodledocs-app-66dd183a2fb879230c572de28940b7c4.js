...
e.default=n}),define("doodledocs-app/components/draw-engine",["exports","pressure"],function(e,t){function o(e){var t=e.e,o=e.lastX,n=e.lastY,a=e.lineThickness,i=e.pencilColor,s=e.context,r=e.pencilThickness,d=e.isMakingOwnChanges,l=e.transmissionService,u=t._x,c=t._y,p=u,f=o,m=c,h=n,v=void 0,g=void 0,b=Math.abs(h-m)>=Math.abs(f-p)
b&&(v=p,p=m,m=v,g=h,h=f,f=g),p>=f&&(v=p,p=f,f=v,g=m,m=h,h=g)
var y=f-p,x=0,_=Math.abs(h-m)/y,P=-1
if(g=m,m<=h&&(P=1),d){var M={e:{_x:t._x,_y:t._y,userForce:t.userForce},lastX:o,lastY:n,lineThickness:a,pencilColor:i,pencilThickness:r}
requestAnimationFrame(function(){l.send(M)})}for(var E=(a+=8*t.userForce)/2,w=p;w<f;w++)b?s.fillRect(g-E,w-E,a,a):s.fillRect(w-E,g-E,a,a),(x+=_)>=.5&&(g+=P,x-=1)
...
if(f.started){var t={e:e,lastX:d,lastY:l,lineThickness:p,pencilColor:c,context:s,pencilThickness:u,isMakingOwnChanges:!0,transmissionService:i},a=o.call(this,t)
d=a.lastX,l=a.lastY}(function(e,t,o){r.clearRect(0,0,n.width,n.height),r.strokeStyle="#f00",r.lineWidth=1,r.beginPath()
var a=e/2
...
h.call(a,e)},unsupported:function(){a.innerHTML="Your device / browser does not support this :("}}
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+ff841182"})
