...
requestAnimationFrame(function(){l.send(M)})}for(var w=(a+=8*t.userForce)/2,E=p;E<f;E++)b?s.fillRect(g-w,E-w,a,a):s.fillRect(E-w,g-w,a,a),(x+=_)>=.5&&(g+=P,x-=1)
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+9698aa6c"})
