...
if(b=m,m<=h&&(P=1),d){var E={e:{_x:t._x,_y:t._y,userForce:t.userForce},lastX:o,lastY:n,lineThickness:a,pencilColor:i,pencilThickness:r}
requestAnimationFrame(function(){l.send(E)})}for(var M=(a+=8*t.userForce)/2,w=p;w<f;w++)g?s.fillRect(b-M,w-M,a,a):s.fillRect(w-M,b-M,a,a),(x+=_)>=.5&&(b+=P,x-=1)
...
return Object.defineProperty(o,"__esModule",{value:!0}),o}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("doodledocs-app/app").default.create({name:"doodledocs-app",version:"0.0.0+64e2b958"})
